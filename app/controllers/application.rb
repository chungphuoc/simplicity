...
require 'r_s_pager/unit_contract_sql_pagee'
...
class ApplicationController < ActionController::Base
    ...
    def log_user_login( username, user_type, successful )
        log "USER_ACTION, LOGIN, #{username.nil? ? "nil" : username}, #{user_type}, #{successful}"
    end
    
    def log_user_logout( username, user_type )
        log "USER_ACTION, LOGOUT, #{username.nil? ? "nil" : username}, #{user_type}"
    end
